                                        ...
                                        <div class="">
                                            ...
                                            @if(\Auth::guard('customer')->check() && \Auth::guard('customer')->user()->is_dealer == 1)
                                                <strike class="__text-12px __color-E96A6A __pl-2">
                                                    {{\App\CPU\Helpers::currency_converter($deal_of_the_day->product->dealer_unit_price)}}
                                                </strike>
                                            @else 
                                                <strike class="__text-12px __color-E96A6A __pl-2">
                                            ...
                                            @if(\Auth::guard('customer')->check() && \Auth::guard('customer')->user()->is_dealer == 1)
                                                ...
                                                {{\App\CPU\Helpers::currency_converter(
                                                    $deal_of_the_day->product->dealer_unit_price-(\App\CPU\Helpers::get_product_discount($deal_of_the_day->product,$deal_of_the_day->product->dealer_unit_price))
                                                )}}
                                                </span>    
                                            @else                                            
                                                <span class="text-accent __text-22px __m-10px">
                                                ...
                                                <div class="best-selling-details">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if(\Auth::guard('customer')->check() && \Auth::guard('customer')->user()->is_dealer == 1)
                                                             <strike class="__color-E96A6A __text-12px">
                                                                {{\App\CPU\Helpers::currency_converter($bestSell->product->dealer_unit_price)}}
                                                            </strike>    
                                                        @else
                                                            <strike class="__color-E96A6A __text-12px">
                                                    ...
                                                    @if(\Auth::guard('customer')->check() && \Auth::guard('customer')->user()->is_dealer == 1)
                                                        <span class="text-accent">
                                                            {{\App\CPU\Helpers::currency_converter(
                                                            $bestSell->product->dealer_unit_price-(\App\CPU\Helpers::get_product_discount($bestSell->product,$bestSell->product->dealer_unit_price))
                                                            )}}
                                                        </span>
                                                    @else 
                                                        <span class="text-accent">
                                            ...
                                            <div class="d-flex flex-wrap p-2">
                                                ...
                                                <div class="top-rated-details">
                                                    ...
                                                    <div>
                                                        ...
                                                        @if(\Auth::guard('customer')->check() && \Auth::guard('customer')->user()->is_dealer == 1)        
                                                            <strike class="__text-12px __color-E96A6A">
                                                                {{\App\CPU\Helpers::currency_converter($top->product->dealer_unit_price)}}
                                                            </strike>
                                                        @else 
                                                            <strike class="__text-12px __color-E96A6A">
                                                    ...
                                                    @if(\Auth::guard('customer')->check() && \Auth::guard('customer')->user()->is_dealer == 1)
                                                        <span class="text-accent">
                                                            {{\App\CPU\Helpers::currency_converter(
                                                            $top->product->dealer_unit_price-(\App\CPU\Helpers::get_product_discount($top->product,$top->product->dealer_unit_price))
                                                            )}}
                                                        </span> 
                                                    @else      
                                                        <span class="text-accent">
