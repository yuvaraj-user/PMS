                                            ...
                                            <div id="collapseThree"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="state" id="address-state" class="form-control selectpicker" data-live-search="true" {{$shipping_addresses->count()==0?'required':''}}>
                                                            @foreach($states as $d)
                                                                <option value="{{ $d }}">{{ $d }}</option>
                                                            @endforeach
                                                        </select>
                                                        <!-- <input class="form-control" type="text" id="address-state" name="state" required> -->
                                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <!-- <div class="form-group">
                                                        <label for="exampleInputEmail1">{{ \App\CPU\translate('State')}}<span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" class="form-control"
                                                               name="state" {{$billing_addresses->count()==0?'required':''}}>
                                                    </div> -->
