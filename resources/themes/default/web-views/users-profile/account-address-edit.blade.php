                ...
                <div class="card-body">
                    <div class="col-12">
                        <form action="{{route('address-update')}}" method="post">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                        <label for="address-state">{{\App\CPU\translate('State')}}</label>
                                        <select name="state" id="address-state" class="form-control selectpicker" data-live-search="true" required>
                                            @foreach($states as $d)
                                                <option value="{{ $d }}" {{ $d == $shippingAddress->state ? 'selected' : ''}}>{{ $d }}</option>
                                            @endforeach
                                        </select>
                                        <!-- <input class="form-control" type="text" id="address-state" name="state" value="{{$shippingAddress->state}}" required> -->
                                </div>
                                <div class="form-group col-md-6">
