                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" id="hsn_code" name="hsn_code" class="form-control" value="{{ old('hsn_code') }}" placeholder="{{ \App\CPU\translate('hsn_code') }}">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row align-items-end">
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                   placeholder="{{ \App\CPU\translate('Customer Unit price') }}" name="unit_price"
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="number" min="0" step="0.01"
                                                    ...
                                                    value="{{ old('dealer_unit_price') }}" required>
                                        </div>
                                        <div class="col-md-6 form-group">
