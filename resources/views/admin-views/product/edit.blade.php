                ...
                <form class="product-form" action="{{route('admin.product.update',$product->id)}}" method="post"
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="title-color" for="exampleFormControlInput1">{{ \App\CPU\translate('hsn_code') }}</label>
                                    <input type="text" id="hsn_code" name="hsn_code" class="form-control" value="{{ $product->hsn_code  }}" placeholder="{{ \App\CPU\translate('hsn_code') }}">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                <div class="col-md-3 form-group">
                                    <label class="title-color">{{\App\CPU\translate('Customer Unit price')}}</label>
                                    <input type="number" min="0" step="0.01"
                                            placeholder="{{\App\CPU\translate('Customer Unit price') }}"
                                            name="unit_price" class="form-control"
                                            value={{\App\CPU\Convert::default($product->unit_price)}} required>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label class="title-color">{{\App\CPU\translate('Dealer Unit price')}}</label>
                                    <input type="number" min="0" step="0.01"
                                            placeholder="{{\App\CPU\translate('Dealer Unit price') }}"
                                            name="dealer_unit_price" class="form-control"
                                            value={{\App\CPU\Convert::default($product->dealer_unit_price)}} required>
                                </div>
                                <div class="col-md-6 form-group">
