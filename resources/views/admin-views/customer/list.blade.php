            ...
            <div class="table-responsive datatable-custom">
                <table
                    ...
                    <tr>
                        ...
                        <th>{{\App\CPU\translate('Customer')}} / {{\App\CPU\translate('Dealer')}}</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="switcher">
                                    <input type="checkbox" class="switcher_input dealer_switcher_input"
                                           id="{{$customer['id']}}" {{$customer->is_dealer == 1?'checked':''}}>
...
@push('script_2')
    <script>
        ...
        $(document).on('change', '.dealer_switcher_input', function () {
            let id = $(this).attr("id");
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.customer.dealer-status-update')}}",
                        method: 'POST',
                        data: {
                            id: id,
                            status: status
