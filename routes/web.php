...
Route::group(['prefix' => 'tally'],function(){
    Route::get('customer_export','TallyintegrationController@customer_export')->name('customer_export');
    Route::get('seller_export','TallyintegrationController@seller_export')->name('seller_export');
    Route::get('product_export','TallyintegrationController@product_export')->name('product_export');
    Route::get('invoice_export','TallyintegrationController@invoice_export')->name('invoice_export');
    Route::get('receipt_export','TallyintegrationController@receipt_export')->name('receipt_export');
    
    Route::get('product_import','TallyintegrationController@product_import')->name('product_import');
    Route::get('customer_import','TallyintegrationController@customer_import')->name('customer_import');
    Route::get('invoice_import','TallyintegrationController@invoice_import')->name('invoice_import');
    Route::get('receipt_import','TallyintegrationController@receipt_import')->name('receipt_import');
