...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.','middleware'=>['module:promotion_management']], function () {
            ...
            Route::get('get_wishlist', 'BusinessSettingsController@wishlist')->name('wishlist');
            Route::post('get_wishlist_excel', 'BusinessSettingsController@wishlist_export')->name('wishlist_excel');
            Route::get('wishlist_push_notification','BusinessSettingsController@wishlist_push_notification')->name('wishlist_push_notication');
            Route::post('wishlist_send_notification', 'BusinessSettingsController@wishlist_send_notification')->name('wishlist_send_notification');
        });
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.','middleware'=>['module:user_section']], function () {
            ...
            Route::post('dealer_status-update', 'CustomerController@dealer_status_update')->name('dealer-status-update');
