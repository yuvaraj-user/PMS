...
class POSController extends Controller
{
    ...
    public function place_order(Request $request)
    {
        ...
        // }
           ...
           $order_id = 100000 + Order::whereNotNull('web_order_id')->get()->count() + 1;
        if (Order::where('web_order_id',$order_id)->first()) {
            $order_id = Order::orderBy('web_order_id', 'DESC')->first()->web_order_id + 1;
