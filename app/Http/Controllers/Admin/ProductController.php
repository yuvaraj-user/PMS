...
class ProductController extends BaseController
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // 'dealer_unit_price'    => 'required|numeric|gt:0',
        ...
        //$p->dealer_unit_price = BackEndHelper::currency_to_usd($request->dealer_unit_price);
    ...
    public function update(Request $request, $id)
    {
        ...
        //$product->dealer_unit_price = BackEndHelper::currency_to_usd($request->dealer_unit_price);
