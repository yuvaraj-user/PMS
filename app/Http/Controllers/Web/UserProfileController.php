...
class UserProfileController extends Controller
{
    ...
    public function account_address()
    {
        ...
        if (auth('customer')->check()) {
            ...
            return view('web-views.users-profile.account-address', compact('shippingAddresses', 'country_restrict_status', 'zip_restrict_status', 'countries', 'zip_codes', 'states'));
        } else {
            return redirect()->route('home');
        }
    }
    ...
    public function address_edit(Request $request, $id)
    {
        ...
        if (isset($shippingAddress)) {
            return view(VIEW_FILE_NAMES['account_address_edit'], compact('shippingAddress', 'country_restrict_status', 'zip_restrict_status', 'delivery_countries', 'delivery_zipcodes','states'));
        } else {
