...
class Product extends Model
{
    ...
    protected $fillable = ['added_by','user_id','name','slug','category_ids','category_id','sub_category_id','unit','current_stock','variation','colors','choice_options','attributes','images','unit_price','purchase_price','tax','unit_price','purchase_price','tax_model','discount','shipping_cost','minimum_order_qty','brand_id','action','is_tally','hsn_code','tally_unique_id','dealer_unit_price'];
